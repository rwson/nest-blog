...
GITHUB_INFO.authUrl = `https://github.com/login/oauth/authorize?client_id=${GITHUB_INFO.id}&redirect_uri=${decodeURIComponent('http://47.105.45.237:3001/oauth/github-callback')}`;
...
export const GOOGLE_INFO = {
  ...
  redirect: 'http://47.105.45.237:3001/oauth/google-callback',
  authBase: 'https://accounts.google.com/o/oauth2/v2/auth',
  tokenUrl: 'https://oauth2.googleapis.cn/token',
