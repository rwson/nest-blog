...
export const ArticleModel = model<ArticleDocument, Model<ArticleDocument>>('article', ArticleSchema, 'article');
export const CategoryModel = model<CategoryDocument, Model<CategoryDocument>>('category', CategorySchema, 'category');
export const CommentModel = model<CommentDocument, Model<CommentDocument>>('comment', CommentSchema, 'comment');
export const FileModel = model<FileDocument, Model<FileDocument>>('file', FileSchema, 'file');
export const TagModel = model<TagDocument, Model<TagDocument>>('tag', TagSchema, 'tag');
